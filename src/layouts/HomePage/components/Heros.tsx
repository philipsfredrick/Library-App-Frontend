          ...
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="ml-2">
              ...
              <p className="lead">
                ...
                work nonstop to provide the most accurate selection for our Luv
                2 read students! We are diligent about our book selection and
          ...
          <div className="m-2">
            ...
            <div className="m-2">
              ...
              <div className="mt-2">
                ...
                <p className="lead">
                  Try to check in daily as our collection is always changing! We
                  work nonstop to provide the most accurate selection for our
                  Luv 2 read students! We are diligent about our book selection
